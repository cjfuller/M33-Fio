...
class M33FioPlugin(
    ...
    def connectedToInternet(self):
        ...
        # Create request
        request = urllib.request.Request("http://exploitkings.com")
        ...
        try:
            self.serverData = json.load(
                urllib.request.urlopen(
                    ...
                    + urllib.parse.quote_plus("Plugin Version".encode("utf-8"))
                    + "="
                    + urllib.parse.quote_plus(self._plugin_version.encode("utf-8"))
                )
            )
        except:
            self.serverData = None
            ...
            # Otherwise check if parameter is to view a profile
                ...
                return flask.jsonify(
                    dict(
                        ...
                        + urllib.parse.quote(destinationName.encode("utf-8")),
                    )
                )
    ...
    def on_printer_add_log(self, data):
                                    ...
                                    if self.getEeprom(connection):
                                        ...
                                        if not error and eepromCrc != chipCrc:
                                            ...
                                            # Otherwise
                                                ...
                                                if (
                                                    not self.updateToProvidedFirmware(
                                                        connection,
                                                        self.getNewestFirmwareName(
                                                            firmwareType
                                                        ),
                                        ...
                                        if (
                                            not error
                                            and firmwareType is not None
                                            and (
                                                firmwareType
                                                + " "
                                                + str(firmwareVersion)
                                            )
                                            in self.providedFirmwares
                                            and self.serverData is not None
                                            and int(bootloaderVersion[1:])
                                            not in self.serverData["Micro 3D"][
                                                "Bootloader Versions"
                                            ]
                                            and str(int(bootloaderVersion[1:]))
                                            not in str(
                                                self._settings.get(
                                                    [
                                                        "Micro3DBootloaderVersionsUploaded"
                                            ...
                                            if not self.reconnectingToPrinter:
                                                ...
                                                self._plugin_manager.send_plugin_message(
                                                    ...
                                                    dict(
                                                        value="Show Question",
                                                        message=gettext(
                                                            "The creator of M33 Fio would like to examine your printer's bootloader to assist in further reverse engineering of the Micro 3D printer. Would you like to extract and send your printer's bootloader to him? The entirely automated process only takes a few seconds, and it would help him out a lot."
                                                        ),
                                                        header=gettext(
                                                            "Developer's Message"
                                                        ),
                                                ...
                                                # Otherwise
                                                    ...
                                                    self._plugin_manager.send_plugin_message(
                                                        ...
                                                        dict(
                                                            value="Show Message",
                                                            message=gettext(
                                                                "Extracting and uploading your printer's bootloader…"
                                                            ),
                                                            header=gettext(
                                                                "Developer's Message"
                                                            ),
                                                    ...
                                                    if (
                                                        ...
                                                        self._plugin_manager.send_plugin_message(
                                                            ...
                                                            dict(
                                                                value="Show Message",
                                                                message=gettext(
                                                                    "Extracting and uploading your printer's bootloader failed"
                                                                ),
                                                                header=gettext(
                                                                    "Developer's Message"
                                                                ),
                                                    ...
                                                    # Otherwise
                                                        ...
                                                        if (
                                                            not result
                                                            or not self.updateToProvidedFirmware(
                                                                connection,
                                                                firmwareType
                                                                + " "
                                                                + str(firmwareVersion),
                                                        ...
                                                        # Otherwise
                                                            ...
                                                            self._plugin_manager.send_plugin_message(
                                                                ...
                                                                dict(
                                                                    value="Show Question",
                                                                    message=gettext(
                                                                        "Extracting and uploading your printer's bootloader was successful. Thanks for helping."
                                                                    ),
                                                                    header=gettext(
                                                                        "Developer's Message"
                                                                    ),
                                        ...
                                        if not error and not self.getEeprom(
                                            connection, True
                                        ):
                            ...
                            # Otherwise
                                ...
                                # Otherwise
                                    ...
                                    # Otherwise
                                        ...
                                        if int(serial.VERSION.split(".", 1)[0]) < 3:
                                            self._printer.get_transport().writeTimeout = (
                                                None
                                            )
                                        else:
                                            self._printer.get_transport().write_timeout = (
                                                None
                                            )
                                        ...
                                        if self._printer._comm is not None:
                                            ...
                                            self.currentFirmwareType = (
                                                self.getFirmwareDetails()[0]
                                            )

                                            # Save original write and read functions
                                            self.originalWrite = (
                                                self._printer.get_transport().write
                                            )
                                            self.originalRead = (
                                                self._printer.get_transport().readline
                                            )
                                            ...
                                            try:
                                                ...
                                                self._printer._comm._changeState(
                                                    self._printer._comm.STATE_OPERATIONAL
                                                )

                                                # Send message
                                                self._plugin_manager.send_plugin_message(
                                                    self._identifier,
                                                    dict(value="Connected To Printer"),
                                                )
        ...
        # Otherwise check if data contains printer information
            ...
            if (
                "MACHINE_TYPE:The_Micro" not in data
                and "MACHINE_TYPE:Micro_3D" not in data
            ):

                # Set write and read functions back to original
                if self.originalWrite is not None and isinstance(
                    self._printer.get_transport(), serial.Serial
                ):
            ...
            # Otherwise
                ...
                commands = [
                    ...
                    "M114",
                    "M619 S"
                    + str(self.eepromOffsets["backlashX"]["offset"])
                    + " T"
                    + str(self.eepromOffsets["backlashX"]["bytes"]),
                    "M619 S"
                    + str(self.eepromOffsets["backlashY"]["offset"])
                    + " T"
                    + str(self.eepromOffsets["backlashY"]["bytes"]),
                    "M619 S"
                    + str(self.eepromOffsets["bedOrientationBackRight"]["offset"])
                    + " T"
                    + str(self.eepromOffsets["bedOrientationBackRight"]["bytes"]),
                    "M619 S"
                    + str(self.eepromOffsets["bedOrientationBackLeft"]["offset"])
                    + " T"
                    + str(self.eepromOffsets["bedOrientationBackLeft"]["bytes"]),
                    "M619 S"
                    + str(self.eepromOffsets["bedOrientationFrontLeft"]["offset"])
                    + " T"
                    + str(self.eepromOffsets["bedOrientationFrontLeft"]["bytes"]),
                    "M619 S"
                    + str(self.eepromOffsets["bedOrientationFrontRight"]["offset"])
                    + " T"
                    + str(self.eepromOffsets["bedOrientationFrontRight"]["bytes"]),
                    "M619 S"
                    + str(self.eepromOffsets["filamentTypeAndLocation"]["offset"])
                    + " T"
                    + str(self.eepromOffsets["filamentTypeAndLocation"]["bytes"]),
                    "M619 S"
                    + str(self.eepromOffsets["filamentTemperature"]["offset"])
                    + " T"
                    + str(self.eepromOffsets["filamentTemperature"]["bytes"]),
                    "M619 S"
                    + str(self.eepromOffsets["bedOffsetBackLeft"]["offset"])
                    + " T"
                    + str(self.eepromOffsets["bedOffsetBackLeft"]["bytes"]),
                    "M619 S"
                    + str(self.eepromOffsets["bedOffsetBackRight"]["offset"])
                    + " T"
                    + str(self.eepromOffsets["bedOffsetBackRight"]["bytes"]),
                    "M619 S"
                    + str(self.eepromOffsets["bedOffsetFrontRight"]["offset"])
                    + " T"
                    + str(self.eepromOffsets["bedOffsetFrontRight"]["bytes"]),
                    "M619 S"
                    + str(self.eepromOffsets["bedOffsetFrontLeft"]["offset"])
                    + " T"
                    + str(self.eepromOffsets["bedOffsetFrontLeft"]["bytes"]),
                    "M619 S"
                    + str(self.eepromOffsets["bedHeightOffset"]["offset"])
                    + " T"
                    + str(self.eepromOffsets["bedHeightOffset"]["bytes"]),
                    "M619 S"
                    + str(self.eepromOffsets["backlashSpeed"]["offset"])
                    + " T"
                    + str(self.eepromOffsets["backlashSpeed"]["bytes"]),
                    "M619 S"
                    + str(self.eepromOffsets["speedLimitX"]["offset"])
                    + " T"
                    + str(self.eepromOffsets["speedLimitX"]["bytes"]),
                    "M619 S"
                    + str(self.eepromOffsets["speedLimitY"]["offset"])
                    + " T"
                    + str(self.eepromOffsets["speedLimitY"]["bytes"]),
                    "M619 S"
                    + str(self.eepromOffsets["speedLimitZ"]["offset"])
                    + " T"
                    + str(self.eepromOffsets["speedLimitZ"]["bytes"]),
                    "M619 S"
                    + str(self.eepromOffsets["speedLimitEPositive"]["offset"])
                    + " T"
                    + str(self.eepromOffsets["speedLimitEPositive"]["bytes"]),
                    "M619 S"
                    + str(self.eepromOffsets["speedLimitENegative"]["offset"])
                    + " T"
                    + str(self.eepromOffsets["speedLimitENegative"]["bytes"]),
                ]

                # Check if not using M3D or M3D Mod firmware
                if (
                    self.currentFirmwareType != "M3D"
                    and self.currentFirmwareType != "M3D Mod"
                ):

                    # Request motor's steps/mm and homing sensitivity
                    commands += [
                        "M619 S"
                        + str(self.eepromOffsets["xMotorStepsPerMm"]["offset"])
                        + " T"
                        + str(self.eepromOffsets["xMotorStepsPerMm"]["bytes"]),
                        "M619 S"
                        + str(self.eepromOffsets["yMotorStepsPerMm"]["offset"])
                        + " T"
                        + str(self.eepromOffsets["yMotorStepsPerMm"]["bytes"]),
                        "M619 S"
                        + str(self.eepromOffsets["zMotorStepsPerMm"]["offset"])
                        + " T"
                        + str(self.eepromOffsets["zMotorStepsPerMm"]["bytes"]),
                        "M619 S"
                        + str(self.eepromOffsets["eMotorStepsPerMm"]["offset"])
                        + " T"
                        + str(self.eepromOffsets["eMotorStepsPerMm"]["bytes"]),
                        "M619 S"
                        + str(self.eepromOffsets["xJerkSensitivity"]["offset"])
                        + " T"
                        + str(self.eepromOffsets["xJerkSensitivity"]["bytes"]),
                        "M619 S"
                        + str(self.eepromOffsets["yJerkSensitivity"]["offset"])
                        + " T"
                        + str(self.eepromOffsets["yJerkSensitivity"]["bytes"]),
                        "M619 S"
                        + str(self.eepromOffsets["calibrateZ0Correction"]["offset"])
                        + " T"
                        + str(self.eepromOffsets["calibrateZ0Correction"]["bytes"]),
                        "M619 S"
                        + str(self.eepromOffsets["expandPrintableRegion"]["offset"])
                        + " T"
                        + str(self.eepromOffsets["expandPrintableRegion"]["bytes"]),
                        "M619 S"
                        + str(self.eepromOffsets["externalBedHeight"]["offset"])
                        + " T"
                        + str(self.eepromOffsets["externalBedHeight"]["bytes"]),
                        "M619 S"
                        + str(self.eepromOffsets["skewX"]["offset"])
                        + " T"
                        + str(self.eepromOffsets["skewX"]["bytes"]),
                        "M619 S"
                        + str(self.eepromOffsets["skewY"]["offset"])
                        + " T"
                        + str(self.eepromOffsets["skewY"]["bytes"]),
                        "M619 S"
                        + str(self.eepromOffsets["heatbedTemperature"]["offset"])
                        + " T"
                        + str(self.eepromOffsets["heatbedTemperature"]["bytes"]),
                    ]
                ...
                commands += [
                    "M619 S"
                    + str(self.eepromOffsets["bedOrientationVersion"]["offset"])
                    + " T"
                    + str(self.eepromOffsets["bedOrientationVersion"]["bytes"])
                ]
        ...
        # Otherwise check if data contains current Z
            ...
            # Otherwise check if performing cancel print movement
                ...
                # Set commands
                commands = ["M104 S0", "G90", "G0 Y%f Z%f F1800" % (moveY, moveZ)]
            ...
            # Otherwise check if starting a mid-print filament change
                ...
                if moveZ >= self.bedHighMinZ:
                    ...
                    minModelX = min(
                        self.minXExtruderLow,
                        self.minXExtruderMedium,
                        self.minXExtruderHigh,
                    )
                    maxModelX = max(
                        self.maxXExtruderLow,
                        self.maxXExtruderMedium,
                        self.maxXExtruderHigh,
                    )
                    minMoveX = self.bedHighMinX
                    maxMoveX = self.bedHighMaxX

                    minModelY = min(
                        self.minYExtruderLow,
                        self.minYExtruderMedium,
                        self.minYExtruderHigh,
                    )
                    maxModelY = max(
                        self.maxYExtruderLow,
                        self.maxYExtruderMedium,
                        self.maxYExtruderHigh,
                    )
                ...
                if moveX is None or moveY is None:
                    ...
                    # Send message
                    self._plugin_manager.send_plugin_message(
                        self._identifier, dict(value="Failed Mid-Print Filament Change")
                    )
        ...
        # Otherwise check if data contains an EEPROM value
            ...
            # Otherwise check if data is for back right orientation
                ...
                if not isinstance(value, float) or math.isnan(value):
                    self.printerBackRightOrientation = self.get_settings_defaults()[
                        "BackRightOrientation"
                    ]
                else:
                ...
                if self._settings.get_boolean(["AutomaticallyObtainSettings"]):
                    self._settings.set_float(
                        ["BackRightOrientation"], self.printerBackRightOrientation
                    )
            ...
            # Otherwise check if data is for back left orientation
                ...
                if not isinstance(value, float) or math.isnan(value):
                    self.printerBackLeftOrientation = self.get_settings_defaults()[
                        "BackLeftOrientation"
                    ]
                else:
                ...
                if self._settings.get_boolean(["AutomaticallyObtainSettings"]):
                    self._settings.set_float(
                        ["BackLeftOrientation"], self.printerBackLeftOrientation
                    )
            ...
            # Otherwise check if data is for front left orientation
                ...
                if not isinstance(value, float) or math.isnan(value):
                    self.printerFrontLeftOrientation = self.get_settings_defaults()[
                        "FrontLeftOrientation"
                    ]
                else:
                ...
                if self._settings.get_boolean(["AutomaticallyObtainSettings"]):
                    self._settings.set_float(
                        ["FrontLeftOrientation"], self.printerFrontLeftOrientation
                    )
            ...
            # Otherwise check if data is for front right orientation
                ...
                if not isinstance(value, float) or math.isnan(value):
                    self.printerFrontRightOrientation = self.get_settings_defaults()[
                        "FrontRightOrientation"
                    ]
                else:
                ...
                if self._settings.get_boolean(["AutomaticallyObtainSettings"]):
                    self._settings.set_float(
                        ["FrontRightOrientation"], self.printerFrontRightOrientation
                    )

                    # Set invalid bed orientation
                    self.invalidBedOrientation = (
                        self.printerBackRightOrientation == 0
                        and self.printerBackLeftOrientation == 0
                        and self.printerFrontLeftOrientation == 0
                        and self.printerFrontRightOrientation == 0
                    )
            ...
            # Otherwise check if data is for filament temperature
                ...
                "PT:" + str(self.eepromOffsets["filamentTemperature"]["offset"]) + " "
                in data
            ):

                # Convert data to value
                self.printerFilamentTemperature = (
                    int(data[data.find("DT:") + 3 :]) + 100
                )

                # Check if set to automatically collect printer settings
                if self._settings.get_boolean(["AutomaticallyObtainSettings"]):
                    self._settings.set_int(
                        ["FilamentTemperature"], self.printerFilamentTemperature
                    )

            # Otherwise check if data is for back left offset
            elif (
                "PT:" + str(self.eepromOffsets["bedOffsetBackLeft"]["offset"]) + " "
                in data
            ):
                ...
                if not isinstance(value, float) or math.isnan(value):
                    self.printerBackLeftOffset = self.get_settings_defaults()[
                        "BackLeftOffset"
                    ]
                else:
                ...
                if self._settings.get_boolean(["AutomaticallyObtainSettings"]):
                    self._settings.set_float(
                        ["BackLeftOffset"], self.printerBackLeftOffset
                    )

            # Otherwise check if data is for back right offset
            elif (
                "PT:" + str(self.eepromOffsets["bedOffsetBackRight"]["offset"]) + " "
                in data
            ):
                ...
                if not isinstance(value, float) or math.isnan(value):
                    self.printerBackRightOffset = self.get_settings_defaults()[
                        "BackRightOffset"
                    ]
                else:
                ...
                if self._settings.get_boolean(["AutomaticallyObtainSettings"]):
                    self._settings.set_float(
                        ["BackRightOffset"], self.printerBackRightOffset
                    )

            # Otherwise check if data is for front right offset
            elif (
                "PT:" + str(self.eepromOffsets["bedOffsetFrontRight"]["offset"]) + " "
                in data
            ):
                ...
                if not isinstance(value, float) or math.isnan(value):
                    self.printerFrontRightOffset = self.get_settings_defaults()[
                        "FrontRightOffset"
                    ]
                else:
                ...
                if self._settings.get_boolean(["AutomaticallyObtainSettings"]):
                    self._settings.set_float(
                        ["FrontRightOffset"], self.printerFrontRightOffset
                    )

            # Otherwise check if data is for front left offset
            elif (
                "PT:" + str(self.eepromOffsets["bedOffsetFrontLeft"]["offset"]) + " "
                in data
            ):
                ...
                if not isinstance(value, float) or math.isnan(value):
                    self.printerFrontLeftOffset = self.get_settings_defaults()[
                        "FrontLeftOffset"
                    ]
                else:
                ...
                if self._settings.get_boolean(["AutomaticallyObtainSettings"]):
                    self._settings.set_float(
                        ["FrontLeftOffset"], self.printerFrontLeftOffset
                    )

            # Otherwise check if data is for bed height offset
            elif (
                "PT:" + str(self.eepromOffsets["bedHeightOffset"]["offset"]) + " "
                in data
            ):
                ...
                if not isinstance(value, float) or math.isnan(value):
                    self.printerBedHeightOffset = self.get_settings_defaults()[
                        "BedHeightOffset"
                    ]
                else:
                ...
                if self._settings.get_boolean(["AutomaticallyObtainSettings"]):
                    self._settings.set_float(
                        ["BedHeightOffset"], self.printerBedHeightOffset
                    )

            # Otherwise check if data is for backlash speed
            elif (
                "PT:" + str(self.eepromOffsets["backlashSpeed"]["offset"]) + " " in data
            ):
                ...
                if not isinstance(value, float) or math.isnan(value):
                    self.printerBacklashSpeed = self.get_settings_defaults()[
                        "BacklashSpeed"
                    ]
                else:
                ...
                if self._settings.get_boolean(["AutomaticallyObtainSettings"]):
                    self._settings.set_float(
                        ["BacklashSpeed"], self.printerBacklashSpeed
                    )
            ...
            # Otherwise check if data is for speed limit X
                ...
                if not isinstance(value, float) or math.isnan(value):
                    self.printerSpeedLimitX = self.get_settings_defaults()[
                        "SpeedLimitX"
                    ]
                else:
            ...
            # Otherwise check if data is for speed limit Y
                ...
                if not isinstance(value, float) or math.isnan(value):
                    self.printerSpeedLimitY = self.get_settings_defaults()[
                        "SpeedLimitY"
                    ]
                else:
            ...
            # Otherwise check if data is for speed limit Z
                ...
                if not isinstance(value, float) or math.isnan(value):
                    self.printerSpeedLimitZ = self.get_settings_defaults()[
                        "SpeedLimitZ"
                    ]
                else:
            ...
            # Otherwise check if data is for speed limit E positive
                ...
                "PT:" + str(self.eepromOffsets["speedLimitEPositive"]["offset"]) + " "
                in data
            ):
                ...
                if not isinstance(value, float) or math.isnan(value):
                    self.printerSpeedLimitEPositive = self.get_settings_defaults()[
                        "SpeedLimitEPositive"
                    ]
                else:
                ...
                if self._settings.get_boolean(["AutomaticallyObtainSettings"]):
                    self._settings.set_float(
                        ["SpeedLimitEPositive"], self.printerSpeedLimitEPositive
                    )

            # Otherwise check if data is for speed limit E negative
            elif (
                "PT:" + str(self.eepromOffsets["speedLimitENegative"]["offset"]) + " "
                in data
            ):
                ...
                if not isinstance(value, float) or math.isnan(value):
                    self.printerSpeedLimitENegative = self.get_settings_defaults()[
                        "SpeedLimitENegative"
                    ]
                else:
                ...
                if self._settings.get_boolean(["AutomaticallyObtainSettings"]):
                    self._settings.set_float(
                        ["SpeedLimitENegative"], self.printerSpeedLimitENegative
                    )

            # Otherwise check if data is for X motor steps/mm
            elif (
                "PT:" + str(self.eepromOffsets["xMotorStepsPerMm"]["offset"]) + " "
                in data
            ):
                ...
                if not isinstance(value, float) or math.isnan(value):
                    self.printerXMotorStepsPerMm = self.get_settings_defaults()[
                        "XMotorStepsPerMm"
                    ]
                else:
                ...
                if self._settings.get_boolean(["AutomaticallyObtainSettings"]):
                    self._settings.set_float(
                        ["XMotorStepsPerMm"], self.printerXMotorStepsPerMm
                    )

            # Otherwise check if data is for Y motor steps/mm
            elif (
                "PT:" + str(self.eepromOffsets["yMotorStepsPerMm"]["offset"]) + " "
                in data
            ):
                ...
                if not isinstance(value, float) or math.isnan(value):
                    self.printerYMotorStepsPerMm = self.get_settings_defaults()[
                        "YMotorStepsPerMm"
                    ]
                else:
                ...
                if self._settings.get_boolean(["AutomaticallyObtainSettings"]):
                    self._settings.set_float(
                        ["YMotorStepsPerMm"], self.printerYMotorStepsPerMm
                    )

            # Otherwise check if data is for Z motor steps/mm
            elif (
                "PT:" + str(self.eepromOffsets["zMotorStepsPerMm"]["offset"]) + " "
                in data
            ):
                ...
                if not isinstance(value, float) or math.isnan(value):
                    self.printerZMotorStepsPerMm = self.get_settings_defaults()[
                        "ZMotorStepsPerMm"
                    ]
                else:
                ...
                if self._settings.get_boolean(["AutomaticallyObtainSettings"]):
                    self._settings.set_float(
                        ["ZMotorStepsPerMm"], self.printerZMotorStepsPerMm
                    )

            # Otherwise check if data is for E motor steps/mm
            elif (
                "PT:" + str(self.eepromOffsets["eMotorStepsPerMm"]["offset"]) + " "
                in data
            ):
                ...
                if not isinstance(value, float) or math.isnan(value):
                    self.printerEMotorStepsPerMm = self.get_settings_defaults()[
                        "EMotorStepsPerMm"
                    ]
                else:
                ...
                if self._settings.get_boolean(["AutomaticallyObtainSettings"]):
                    self._settings.set_float(
                        ["EMotorStepsPerMm"], self.printerEMotorStepsPerMm
                    )

            # Otherwise check if data is for X jerk sensitivity
            elif (
                "PT:" + str(self.eepromOffsets["xJerkSensitivity"]["offset"]) + " "
                in data
            ):
                ...
                if self._settings.get_boolean(["AutomaticallyObtainSettings"]):
                    self._settings.set_int(
                        ["XJerkSensitivity"], self.printerXJerkSensitivity
                    )

            # Otherwise check if data is for Y jerk sensitivity
            elif (
                "PT:" + str(self.eepromOffsets["yJerkSensitivity"]["offset"]) + " "
                in data
            ):
                ...
                if self._settings.get_boolean(["AutomaticallyObtainSettings"]):
                    self._settings.set_int(
                        ["YJerkSensitivity"], self.printerYJerkSensitivity
                    )

            # Otherwise check if data is for calibrate Z0 correction
            elif (
                "PT:" + str(self.eepromOffsets["calibrateZ0Correction"]["offset"]) + " "
                in data
            ):
                ...
                if not isinstance(value, float) or math.isnan(value):
                    self.printerCalibrateZ0Correction = self.get_settings_defaults()[
                        "CalibrateZ0Correction"
                    ]
                else:
                ...
                if self._settings.get_boolean(["AutomaticallyObtainSettings"]):
                    self._settings.set_float(
                        ["CalibrateZ0Correction"], self.printerCalibrateZ0Correction
                    )

            # Otherwise check if data is for expand printable region
            elif (
                "PT:" + str(self.eepromOffsets["expandPrintableRegion"]["offset"]) + " "
                in data
            ):

                # Convert data to value
                self.printerExpandPrintableRegion = (
                    int(data[data.find("DT:") + 3 :]) != 0
                )

                # Check if set to automatically collect printer settings
                if self._settings.get_boolean(["AutomaticallyObtainSettings"]):
                    self._settings.set_boolean(
                        ["ExpandPrintableRegion"], self.printerExpandPrintableRegion
                    )

            # Otherwise check if data is for external bed height
            elif (
                "PT:" + str(self.eepromOffsets["externalBedHeight"]["offset"]) + " "
                in data
            ):
                ...
                if not isinstance(value, float) or math.isnan(value):
                    self.printerExternalBedHeight = self.get_settings_defaults()[
                        "ExternalBedHeight"
                    ]
                else:
                ...
                if self._settings.get_boolean(["AutomaticallyObtainSettings"]):
                    self._settings.set_float(
                        ["ExternalBedHeight"], self.printerExternalBedHeight
                    )
            ...
            # Otherwise check if data is for heatbed temperature
                ...
                "PT:" + str(self.eepromOffsets["heatbedTemperature"]["offset"]) + " "
                in data
            ):
                ...
                if self._settings.get_boolean(["AutomaticallyObtainSettings"]):
                    self._settings.set_int(
                        ["HeatbedTemperature"], self.printerHeatbedTemperature
                    )

            # Otherwise check if data is for bed orientation version
            elif (
                "PT:" + str(self.eepromOffsets["bedOrientationVersion"]["offset"]) + " "
                in data
            ):

                # Set invalid bed orientation
                self.invalidBedOrientation = (
                    data[data.find("DT:") + 3 :] == "0"
                    or data[data.find("DT:") + 3 :] == "255"
                    or self.invalidBedOrientation
                )
                ...
                self._plugin_manager.send_plugin_message(
                    ...
                    dict(
                        value="Invalid",
                        bedCenter=self.invalidBedCenter,
                        bedPlane=self.invalidBedPlane,
                        bedOrientation=self.invalidBedOrientation,
                    ),
                )
    ...
    def getSaveCommands(self):
        ...
        if not isinstance(softwareBackLeftOrientation, float):
            softwareBackLeftOrientation = self.get_settings_defaults()[
                "BackLeftOrientation"
            ]

        softwareBackRightOrientation = self._settings.get_float(
            ["BackRightOrientation"]
        )
        if not isinstance(softwareBackRightOrientation, float):
            softwareBackRightOrientation = self.get_settings_defaults()[
                "BackRightOrientation"
            ]

        softwareFrontRightOrientation = self._settings.get_float(
            ["FrontRightOrientation"]
        )
        if not isinstance(softwareFrontRightOrientation, float):
            softwareFrontRightOrientation = self.get_settings_defaults()[
                "FrontRightOrientation"
            ]

        softwareFrontLeftOrientation = self._settings.get_float(
            ["FrontLeftOrientation"]
        )
        if not isinstance(softwareFrontLeftOrientation, float):
            softwareFrontLeftOrientation = self.get_settings_defaults()[
                "FrontLeftOrientation"
            ]
        ...
        if not isinstance(softwareFilamentTemperature, int):
            softwareFilamentTemperature = self.get_settings_defaults()[
                "FilamentTemperature"
            ]
        ...
        if not isinstance(softwareSpeedLimitEPositive, float):
            softwareSpeedLimitEPositive = self.get_settings_defaults()[
                "SpeedLimitEPositive"
            ]
        ...
        if not isinstance(softwareSpeedLimitENegative, float):
            softwareSpeedLimitENegative = self.get_settings_defaults()[
                "SpeedLimitENegative"
            ]
        ...
        softwareCalibrateZ0Correction = self._settings.get_float(
            ["CalibrateZ0Correction"]
        )
        if not isinstance(softwareCalibrateZ0Correction, float):
            softwareCalibrateZ0Correction = self.get_settings_defaults()[
                "CalibrateZ0Correction"
            ]

        softwareExpandPrintableRegion = self._settings.get_boolean(
            ["ExpandPrintableRegion"]
        )
        if not isinstance(softwareExpandPrintableRegion, bool):
            softwareExpandPrintableRegion = self.get_settings_defaults()[
                "ExpandPrintableRegion"
            ]

        softwareExternalBedHeight = self._settings.get_float(["ExternalBedHeight"])
        if not isinstance(softwareExternalBedHeight, float):
            softwareExternalBedHeight = self.get_settings_defaults()[
                "ExternalBedHeight"
            ]
        ...
        if not isinstance(softwareHeatbedTemperature, int):
            softwareHeatbedTemperature = self.get_settings_defaults()[
                "HeatbedTemperature"
            ]
        ...
        commandList = []
        if (
            hasattr(self, "printerBacklashX")
            and self.printerBacklashX != softwareBacklashX
        ):
            ...
            commandList += [
                ...
                + str(self.eepromOffsets["backlashX"]["bytes"])
                + " P"
                + str(self.floatToInt(softwareBacklashX)),
                "M619 S"
                + str(self.eepromOffsets["backlashX"]["offset"])
                + " T"
                + str(self.eepromOffsets["backlashX"]["bytes"]),
        ...
        if (
            hasattr(self, "printerBacklashY")
            and self.printerBacklashY != softwareBacklashY
        ):
            ...
            commandList += [
                ...
                + str(self.eepromOffsets["backlashY"]["bytes"])
                + " P"
                + str(self.floatToInt(softwareBacklashY)),
                "M619 S"
                + str(self.eepromOffsets["backlashY"]["offset"])
                + " T"
                + str(self.eepromOffsets["backlashY"]["bytes"]),
        ...
        if (
            hasattr(self, "printerBackRightOrientation")
            and self.printerBackRightOrientation != softwareBackRightOrientation
        ):
            ...
            commandList += [
                ...
                + str(self.eepromOffsets["bedOrientationBackRight"]["bytes"])
                + " P"
                + str(self.floatToInt(softwareBackRightOrientation)),
                "M619 S"
                + str(self.eepromOffsets["bedOrientationBackRight"]["offset"])
                + " T"
                + str(self.eepromOffsets["bedOrientationBackRight"]["bytes"]),
        ...
        if (
            hasattr(self, "printerBackLeftOrientation")
            and self.printerBackLeftOrientation != softwareBackLeftOrientation
        ):
            ...
            commandList += [
                ...
                + str(self.eepromOffsets["bedOrientationBackLeft"]["bytes"])
                + " P"
                + str(self.floatToInt(softwareBackLeftOrientation)),
                "M619 S"
                + str(self.eepromOffsets["bedOrientationBackLeft"]["offset"])
                + " T"
                + str(self.eepromOffsets["bedOrientationBackLeft"]["bytes"]),
        ...
        if (
            hasattr(self, "printerFrontLeftOrientation")
            and self.printerFrontLeftOrientation != softwareFrontLeftOrientation
        ):
            ...
            commandList += [
                ...
                + str(self.eepromOffsets["bedOrientationFrontLeft"]["bytes"])
                + " P"
                + str(self.floatToInt(softwareFrontLeftOrientation)),
                "M619 S"
                + str(self.eepromOffsets["bedOrientationFrontLeft"]["offset"])
                + " T"
                + str(self.eepromOffsets["bedOrientationFrontLeft"]["bytes"]),
        ...
        if (
            hasattr(self, "printerFrontRightOrientation")
            and self.printerFrontRightOrientation != softwareFrontRightOrientation
        ):
            ...
            commandList += [
                ...
                + str(self.eepromOffsets["bedOrientationFrontRight"]["bytes"])
                + " P"
                + str(self.floatToInt(softwareFrontRightOrientation)),
                "M619 S"
                + str(self.eepromOffsets["bedOrientationFrontRight"]["offset"])
                + " T"
                + str(self.eepromOffsets["bedOrientationFrontRight"]["bytes"]),
        ...
        if (
            hasattr(self, "printerBacklashSpeed")
            and self.printerBacklashSpeed != softwareBacklashSpeed
        ):
            ...
            commandList += [
                ...
                + str(self.eepromOffsets["backlashSpeed"]["bytes"])
                + " P"
                + str(self.floatToInt(softwareBacklashSpeed)),
                "M619 S"
                + str(self.eepromOffsets["backlashSpeed"]["offset"])
                + " T"
                + str(self.eepromOffsets["backlashSpeed"]["bytes"]),
        ...
        if (
            hasattr(self, "printerBackLeftOffset")
            and self.printerBackLeftOffset != softwareBackLeftOffset
        ):
            ...
            commandList += [
                ...
                + str(self.eepromOffsets["bedOffsetBackLeft"]["bytes"])
                + " P"
                + str(self.floatToInt(softwareBackLeftOffset)),
                "M619 S"
                + str(self.eepromOffsets["bedOffsetBackLeft"]["offset"])
                + " T"
                + str(self.eepromOffsets["bedOffsetBackLeft"]["bytes"]),
        ...
        if (
            hasattr(self, "printerBackRightOffset")
            and self.printerBackRightOffset != softwareBackRightOffset
        ):
            ...
            commandList += [
                ...
                + str(self.eepromOffsets["bedOffsetBackRight"]["bytes"])
                + " P"
                + str(self.floatToInt(softwareBackRightOffset)),
                "M619 S"
                + str(self.eepromOffsets["bedOffsetBackRight"]["offset"])
                + " T"
                + str(self.eepromOffsets["bedOffsetBackRight"]["bytes"]),
        ...
        if (
            hasattr(self, "printerFrontRightOffset")
            and self.printerFrontRightOffset != softwareFrontRightOffset
        ):
            ...
            commandList += [
                ...
                + str(self.eepromOffsets["bedOffsetFrontRight"]["bytes"])
                + " P"
                + str(self.floatToInt(softwareFrontRightOffset)),
                "M619 S"
                + str(self.eepromOffsets["bedOffsetFrontRight"]["offset"])
                + " T"
                + str(self.eepromOffsets["bedOffsetFrontRight"]["bytes"]),
        ...
        if (
            hasattr(self, "printerFrontLeftOffset")
            and self.printerFrontLeftOffset != softwareFrontLeftOffset
        ):
            ...
            commandList += [
                ...
                + str(self.eepromOffsets["bedOffsetFrontLeft"]["bytes"])
                + " P"
                + str(self.floatToInt(softwareFrontLeftOffset)),
                "M619 S"
                + str(self.eepromOffsets["bedOffsetFrontLeft"]["offset"])
                + " T"
                + str(self.eepromOffsets["bedOffsetFrontLeft"]["bytes"]),
        ...
        if (
            hasattr(self, "printerBedHeightOffset")
            and self.printerBedHeightOffset != softwareBedHeightOffset
        ):
            ...
            commandList += [
                ...
                + str(self.eepromOffsets["bedHeightOffset"]["bytes"])
                + " P"
                + str(self.floatToInt(softwareBedHeightOffset)),
                "M619 S"
                + str(self.eepromOffsets["bedHeightOffset"]["offset"])
                + " T"
                + str(self.eepromOffsets["bedHeightOffset"]["bytes"]),
        ...
        if (
            hasattr(self, "printerFilamentTemperature")
            and self.printerFilamentTemperature != softwareFilamentTemperature
        ):
            ...
            commandList += [
                ...
                + str(self.eepromOffsets["filamentTemperature"]["bytes"])
                + " P"
                + str(softwareFilamentTemperature - 100),
                "M619 S"
                + str(self.eepromOffsets["filamentTemperature"]["offset"])
                + " T"
                + str(self.eepromOffsets["filamentTemperature"]["bytes"]),
        ...
        if (
            hasattr(self, "printerFilamentType")
            and self.printerFilamentType != softwareFilamentType
        ):
        ...
        if (
            hasattr(self, "printerSpeedLimitX")
            and self.printerSpeedLimitX != softwareSpeedLimitX
        ):
            ...
            commandList += [
                ...
                + str(self.eepromOffsets["speedLimitX"]["bytes"])
                + " P"
                + str(self.floatToInt(softwareSpeedLimitX)),
                "M619 S"
                + str(self.eepromOffsets["speedLimitX"]["offset"])
                + " T"
                + str(self.eepromOffsets["speedLimitX"]["bytes"]),
        ...
        if (
            hasattr(self, "printerSpeedLimitY")
            and self.printerSpeedLimitY != softwareSpeedLimitY
        ):
            ...
            commandList += [
                ...
                + str(self.eepromOffsets["speedLimitY"]["bytes"])
                + " P"
                + str(self.floatToInt(softwareSpeedLimitY)),
                "M619 S"
                + str(self.eepromOffsets["speedLimitY"]["offset"])
                + " T"
                + str(self.eepromOffsets["speedLimitY"]["bytes"]),
        ...
        if (
            hasattr(self, "printerSpeedLimitZ")
            and self.printerSpeedLimitZ != softwareSpeedLimitZ
        ):
            ...
            commandList += [
                ...
                + str(self.eepromOffsets["speedLimitZ"]["bytes"])
                + " P"
                + str(self.floatToInt(softwareSpeedLimitZ)),
                "M619 S"
                + str(self.eepromOffsets["speedLimitZ"]["offset"])
                + " T"
                + str(self.eepromOffsets["speedLimitZ"]["bytes"]),
        ...
        if (
            hasattr(self, "printerSpeedLimitEPositive")
            and self.printerSpeedLimitEPositive != softwareSpeedLimitEPositive
        ):
            ...
            commandList += [
                ...
                + str(self.eepromOffsets["speedLimitEPositive"]["bytes"])
                + " P"
                + str(self.floatToInt(softwareSpeedLimitEPositive)),
                "M619 S"
                + str(self.eepromOffsets["speedLimitEPositive"]["offset"])
                + " T"
                + str(self.eepromOffsets["speedLimitEPositive"]["bytes"]),
        ...
        if (
            hasattr(self, "printerSpeedLimitENegative")
            and self.printerSpeedLimitENegative != softwareSpeedLimitENegative
        ):
            ...
            commandList += [
                ...
                + str(self.eepromOffsets["speedLimitENegative"]["bytes"])
                + " P"
                + str(self.floatToInt(softwareSpeedLimitENegative)),
                "M619 S"
                + str(self.eepromOffsets["speedLimitENegative"]["offset"])
                + " T"
                + str(self.eepromOffsets["speedLimitENegative"]["bytes"]),
        ...
        if self.currentFirmwareType != "M3D" and self.currentFirmwareType != "M3D Mod":
            ...
            if (
                hasattr(self, "printerXMotorStepsPerMm")
                and self.printerXMotorStepsPerMm != softwareXMotorStepsPerMm
            ):
                ...
                commandList += [
                    ...
                    + str(self.eepromOffsets["xMotorStepsPerMm"]["bytes"])
                    + " P"
                    + str(self.floatToInt(softwareXMotorStepsPerMm)),
                    "M619 S"
                    + str(self.eepromOffsets["xMotorStepsPerMm"]["offset"])
                    + " T"
                    + str(self.eepromOffsets["xMotorStepsPerMm"]["bytes"]),
            ...
            if (
                hasattr(self, "printerYMotorStepsPerMm")
                and self.printerYMotorStepsPerMm != softwareYMotorStepsPerMm
            ):
                ...
                commandList += [
                    ...
                    + str(self.eepromOffsets["yMotorStepsPerMm"]["bytes"])
                    + " P"
                    + str(self.floatToInt(softwareYMotorStepsPerMm)),
                    "M619 S"
                    + str(self.eepromOffsets["yMotorStepsPerMm"]["offset"])
                    + " T"
                    + str(self.eepromOffsets["yMotorStepsPerMm"]["bytes"]),
            ...
            if (
                hasattr(self, "printerZMotorStepsPerMm")
                and self.printerZMotorStepsPerMm != softwareZMotorStepsPerMm
            ):
                ...
                commandList += [
                    ...
                    + str(self.eepromOffsets["zMotorStepsPerMm"]["bytes"])
                    + " P"
                    + str(self.floatToInt(softwareZMotorStepsPerMm)),
                    "M619 S"
                    + str(self.eepromOffsets["zMotorStepsPerMm"]["offset"])
                    + " T"
                    + str(self.eepromOffsets["zMotorStepsPerMm"]["bytes"]),
            ...
            if (
                hasattr(self, "printerEMotorStepsPerMm")
                and self.printerEMotorStepsPerMm != softwareEMotorStepsPerMm
            ):
                ...
                commandList += [
                    ...
                    + str(self.eepromOffsets["eMotorStepsPerMm"]["bytes"])
                    + " P"
                    + str(self.floatToInt(softwareEMotorStepsPerMm)),
                    "M619 S"
                    + str(self.eepromOffsets["eMotorStepsPerMm"]["offset"])
                    + " T"
                    + str(self.eepromOffsets["eMotorStepsPerMm"]["bytes"]),
            ...
            if (
                hasattr(self, "printerXJerkSensitivity")
                and self.printerXJerkSensitivity != softwareXJerkSensitivity
            ):
            ...
            if (
                hasattr(self, "printerYJerkSensitivity")
                and self.printerYJerkSensitivity != softwareYJerkSensitivity
            ):
            ...
            if (
                hasattr(self, "printerCalibrateZ0Correction")
                and self.printerCalibrateZ0Correction != softwareCalibrateZ0Correction
            ):
                ...
                commandList += [
                    ...
                    + str(self.eepromOffsets["calibrateZ0Correction"]["bytes"])
                    + " P"
                    + str(self.floatToInt(softwareCalibrateZ0Correction)),
                    "M619 S"
                    + str(self.eepromOffsets["calibrateZ0Correction"]["offset"])
                    + " T"
                    + str(self.eepromOffsets["calibrateZ0Correction"]["bytes"]),
            ...
            if (
                hasattr(self, "printerExpandPrintableRegion")
                and self.printerExpandPrintableRegion != softwareExpandPrintableRegion
            ):
            ...
            if (
                hasattr(self, "printerExternalBedHeight")
                and self.printerExternalBedHeight != softwareExternalBedHeight
            ):
                ...
                commandList += [
                    ...
                    + str(self.eepromOffsets["externalBedHeight"]["bytes"])
                    + " P"
                    + str(self.floatToInt(softwareExternalBedHeight)),
                    "M619 S"
                    + str(self.eepromOffsets["externalBedHeight"]["offset"])
                    + " T"
                    + str(self.eepromOffsets["externalBedHeight"]["bytes"]),
            ...
            if hasattr(self, "printerSkewX") and self.printerSkewX != softwareSkewX:
                ...
                commandList += [
                    ...
                    + str(self.eepromOffsets["skewX"]["bytes"])
                    + " P"
                    + str(self.floatToInt(softwareSkewX)),
                    "M619 S"
                    + str(self.eepromOffsets["skewX"]["offset"])
                    + " T"
                    + str(self.eepromOffsets["skewX"]["bytes"]),
            ...
            if hasattr(self, "printerSkewY") and self.printerSkewY != softwareSkewY:
                ...
                commandList += [
                    ...
                    + str(self.eepromOffsets["skewY"]["bytes"])
                    + " P"
                    + str(self.floatToInt(softwareSkewY)),
                    "M619 S"
                    + str(self.eepromOffsets["skewY"]["offset"])
                    + " T"
                    + str(self.eepromOffsets["skewY"]["bytes"]),
            ...
            if (
                hasattr(self, "printerHeatbedTemperature")
                and self.printerHeatbedTemperature != softwareHeatbedTemperature
            ):
                ...
                commandList += [
                    ...
                    + str(self.eepromOffsets["heatbedTemperature"]["bytes"])
                    + " P"
                    + str(softwareHeatbedTemperature),
                    "M619 S"
                    + str(self.eepromOffsets["heatbedTemperature"]["offset"])
                    + " T"
                    + str(self.eepromOffsets["heatbedTemperature"]["bytes"]),
    ...
    def preprocessGcode(
        ...
        **kwargs
        ...
        if (
            not octoprint.filemanager.valid_file_type(path, "gcode")
            or self._settings.get_boolean(["NotUsingAMicro3DPrinter"])
            or self.skipPreprocessing
        ):
        ...
        if not self._settings.get_boolean(["PreprocessOnTheFly"]):
            ...
            self._plugin_manager.send_plugin_message(
                ...
                dict(
                    ...
                    text=gettext("Collecting print information …"),
                ),
            )
            ...
            if not self.processingSlice:
                ...
                # Display message
                self._plugin_manager.send_plugin_message(
                    self._identifier, dict(value="Pre-processing file")
                )
            ...
            if self.loadSharedLibrary():
                ...
                # Collect print information
                printIsValid = self.sharedLibrary.collectPrintInformation(
                    ctypes.c_char_p(input), ctypes.c_bool(True)
                )
            ...
            if not printIsValid:
                ...
                if self.processingSlice:
                    ...
                    self._plugin_manager.send_plugin_message(
                        self._identifier,
                        dict(value="Progress bar percent", percent="0"),
                    )
                    ...
                    self._plugin_manager.send_plugin_message(
                        ...
                        dict(
                            ...
                            text=gettext(
                                "Could not slice the file. The dimensions of the model go outside the bounds of the printer."
                            ),
                        ),
                    )
                ...
                # Otherwise
                    ...
                    self._plugin_manager.send_plugin_message(
                        self._identifier,
                        dict(
                            value="Change last message",
                            text=gettext(
                                "Could not upload the file. The dimensions of the model go outside the bounds of the printer."
                            ),
                        ),
                    )
                ...
                if (
                    ...
                    self._plugin_manager.send_plugin_message(
                        ...
                        dict(
                            ...
                            type="notice",
                            title=gettext("Print warning"),
                            text=gettext("Object too large to center on print bed"),
                        ),
                    )
            ...
            if self.sharedLibrary:
                ...
                self._plugin_manager.send_plugin_message(
                    self._identifier,
                    dict(value="Progress bar text", text=gettext("Pre‐processing …")),
                )

                # Pre-process file
                self.sharedLibrary.preprocess(
                    ctypes.c_char_p(temp), ctypes.c_char_p(input), ctypes.c_bool(False)
                )

                # Set progress bar percent
                self._plugin_manager.send_plugin_message(
                    self._identifier, dict(value="Progress bar percent", percent="0")
                )
    ...
    def collectPrintInformation(self, file, applyPreprocessors):
        ...
        for line in open(file):
            ...
            if gcode.parseLine(line):
                ...
                if (
                    self.detectedFanSpeed is None
                    and gcode.hasValue("M")
                    and gcode.getValue("M") == "106"
                ):
                ...
                # Otherwise check if command is a mid-print filament change
                    ...
                    not self.detectedMidPrintFilamentChange
                    and gcode.hasValue("M")
                    and gcode.getValue("M") == "600"
                ):
                ...
                # Otherwise check if command is a G command
                    ...
                    if gcode.getValue("G") == "0" or gcode.getValue("G") == "1":
                        ...
                        if gcode.hasValue("Z"):
                            ...
                            if (
                                ...
                                and not self.printingTestBorder
                                and not self.printingBacklashCalibration
                                and (
                                    localZ < self.bedLowMinZ
                                    or localZ > self.bedHighMaxZ
                                )
                            ):
                        ...
                        if (
                            ...
                            if tier == "Low" and (
                                (
                                    localX is not None
                                    and (
                                        localX < self.bedLowMinX
                                        or localX > self.bedLowMaxX
                                    )
                                )
                                or (
                                    localY is not None
                                    and (
                                        localY < self.bedLowMinY
                                        or localY > self.bedLowMaxY
                                    )
                                )
                            ):
                                return False

                            elif tier == "Medium" and (
                                (
                                    localX is not None
                                    and (
                                        localX < self.bedMediumMinX
                                        or localX > self.bedMediumMaxX
                                    )
                                )
                                or (
                                    localY is not None
                                    and (
                                        localY < self.bedMediumMinY
                                        or localY > self.bedMediumMaxY
                                    )
                                )
                            ):
                                return False
                                ...
                                (
                                    localX is not None
                                    and (
                                        localX < self.bedHighMinX
                                        or localX > self.bedHighMaxX
                                    )
                                )
                                or (
                                    localY is not None
                                    and (
                                        localY < self.bedHighMinY
                                        or localY > self.bedHighMaxY
                                    )
                                )
                            ):
                                return False
                        ...
                        if tier == "Low":
                            ...
                            if localX is not None:
                                self.minXExtruderMedium = min(
                                    self.minXExtruderMedium, localX
                                )
                                self.maxXExtruderMedium = max(
                                    self.maxXExtruderMedium, localX
                                )
                            if localY is not None:
                                self.minYExtruderMedium = min(
                                    self.minYExtruderMedium, localY
                                )
                                self.maxYExtruderMedium = max(
                                    self.maxYExtruderMedium, localY
                                )
                        else:
                            if localX is not None:
                                self.minXExtruderHigh = min(
                                    self.minXExtruderHigh, localX
                                )
                                self.maxXExtruderHigh = max(
                                    self.maxXExtruderHigh, localX
                                )
                            if localY is not None:
                                self.minYExtruderHigh = min(
                                    self.minYExtruderHigh, localY
                                )
                                self.maxYExtruderHigh = max(
                                    self.maxYExtruderHigh, localY
                                )
                    ...
                    # Otherwise check if command is G92
                        ...
                        if (
                            not gcode.hasValue("X")
                            and not gcode.hasValue("Y")
                            and not gcode.hasValue("Z")
                            and not gcode.hasValue("E")
                        ):
        ...
        if (
            applyPreprocessors
            and self._settings.get_boolean(["UseCenterModelPreprocessor"])
            and not self.printingTestBorder
            and not self.printingBacklashCalibration
        ):
            ...
            self.displacementX = (
                self.bedWidth
                - self.bedCenterOffsetX
                - max(
                    self.maxXExtruderLow,
                    max(self.maxXExtruderMedium, self.maxXExtruderHigh),
                )
                - min(
                    self.minXExtruderLow,
                    min(self.minXExtruderMedium, self.minXExtruderHigh),
                )
                - self.bedCenterOffsetX
            ) / 2
            self.displacementY = (
                self.bedDepth
                - self.bedCenterOffsetY
                - max(
                    self.maxYExtruderLow,
                    max(self.maxYExtruderMedium, self.maxYExtruderHigh),
                )
                - min(
                    self.minYExtruderLow,
                    min(self.minYExtruderMedium, self.minYExtruderHigh),
                )
                - self.bedCenterOffsetY
            ) / 2
            ...
            negativeDisplacementX = max(
                self.maxXExtruderLow - self.bedLowMaxX, negativeDisplacementX
            )
            negativeDisplacementX = max(
                self.maxXExtruderMedium - self.bedMediumMaxX, negativeDisplacementX
            )
            negativeDisplacementX = max(
                self.maxXExtruderHigh - self.bedHighMaxX, negativeDisplacementX
            )

            # Get positive displacement X
            positiveDisplacementX = 0
            positiveDisplacementX = max(
                self.bedLowMinX - self.minXExtruderLow, positiveDisplacementX
            )
            positiveDisplacementX = max(
                self.bedMediumMinX - self.minXExtruderMedium, positiveDisplacementX
            )
            positiveDisplacementX = max(
                self.bedHighMinX - self.minXExtruderHigh, positiveDisplacementX
            )
            ...
            negativeDisplacementY = max(
                self.maxYExtruderLow - self.bedLowMaxY, negativeDisplacementY
            )
            negativeDisplacementY = max(
                self.maxYExtruderMedium - self.bedMediumMaxY, negativeDisplacementY
            )
            negativeDisplacementY = max(
                self.maxYExtruderHigh - self.bedHighMaxY, negativeDisplacementY
            )

            # Get positive displacement Y
            positiveDisplacementY = 0
            positiveDisplacementY = max(
                self.bedLowMinY - self.minYExtruderLow, positiveDisplacementY
            )
            positiveDisplacementY = max(
                self.bedMediumMinY - self.minYExtruderMedium, positiveDisplacementY
            )
            positiveDisplacementY = max(
                self.bedHighMinY - self.minYExtruderHigh, positiveDisplacementY
            )
            ...
            if not self._settings.get_boolean(["IgnorePrintDimensionLimitations"]) and (
                self.minZExtruder < self.bedLowMinZ
                or self.maxZExtruder > self.bedHighMaxZ
                or self.maxXExtruderLow > self.bedLowMaxX
                or self.maxXExtruderMedium > self.bedMediumMaxX
                or self.maxXExtruderHigh > self.bedHighMaxX
                or self.maxYExtruderLow > self.bedLowMaxY
                or self.maxYExtruderMedium > self.bedMediumMaxY
                or self.maxYExtruderHigh > self.bedHighMaxY
                or self.minXExtruderLow < self.bedLowMinX
                or self.minXExtruderMedium < self.bedMediumMinX
                or self.minXExtruderHigh < self.bedHighMinX
                or self.minYExtruderLow < self.bedLowMinY
                or self.minYExtruderMedium < self.bedMediumMinY
                or self.minYExtruderHigh < self.bedHighMinY
            ):
        ...
        if (
            str(self._settings.get(["FilamentType"])) == "PLA"
            or str(self._settings.get(["FilamentType"])) == "CAM"
            or str(self._settings.get(["FilamentType"])) == "ABS"
            or str(self._settings.get(["FilamentType"])) == "HIPS"
            or str(self._settings.get(["FilamentType"])) == "FLX"
            or str(self._settings.get(["FilamentType"])) == "TGH"
            or str(self._settings.get(["FilamentType"])) == "ABS-R"
        ):
            ...
            if (
                ...
                str(self._settings.get(["FilamentType"])) == "FLX"
                or str(self._settings.get(["FilamentType"])) == "TGH"
            ):
                self.firstLayerTemperatureChange = -5
            elif (
                str(self._settings.get(["FilamentType"])) == "ABS"
                or str(self._settings.get(["FilamentType"])) == "HIPS"
                or str(self._settings.get(["FilamentType"])) == "ABS-R"
            ):
        ...
        if self.detectedFanSpeed is None or self._settings.get_boolean(
            ["RemoveFanCommands"]
        ):
        ...
        if (
            self._settings.get_boolean(["UsePreparationPreprocessor"])
            or self.printingTestBorder
            or self.printingBacklashCalibration
        ):
        ...
        self.midPrintFilamentChangeLayers = re.findall(
            "\\d+", str(self._settings.get(["MidPrintFilamentChangeLayers"]))
        )
    ...
    def isSharpCornerForThermalBonding(self, point, refrence, angle):
        ...
        denominator = math.pow(currentX * currentX + currentY * currentY, 2) * math.pow(
            previousX * previousX + previousY * previousY, 2
        )
        if denominator == 0:
        ...
        # Otherwise
            ...
            try:
                value = math.acos(
                    (currentX * previousX + currentY * previousY) / denominator
                )
    ...
    def getHeightAdjustmentRequired(self, x, y):
        ...
        vector = Vector(
            99,
            95,
            self._settings.get_float(["BackRightOrientation"])
            + self._settings.get_float(["BackRightOffset"]),
        )
        vector2 = Vector(
            9,
            95,
            self._settings.get_float(["BackLeftOrientation"])
            + self._settings.get_float(["BackLeftOffset"]),
        )
        vector3 = Vector(
            9,
            5,
            self._settings.get_float(["FrontLeftOrientation"])
            + self._settings.get_float(["FrontLeftOffset"]),
        )
        vector4 = Vector(
            99,
            5,
            self._settings.get_float(["FrontRightOrientation"])
            + self._settings.get_float(["FrontRightOffset"]),
        )
        ...
        if x <= vector3.x and y >= vector.y:
            return (
                self.getZFromXYAndPlane(point, planeABC)
                + self.getZFromXYAndPlane(point, vector7)
            ) / 2

        elif x <= vector3.x and y <= vector3.y:
            return (
                self.getZFromXYAndPlane(point, vector9)
                + self.getZFromXYAndPlane(point, vector7)
            ) / 2
            ...
            return (
                self.getZFromXYAndPlane(point, vector9)
                + self.getZFromXYAndPlane(point, vector8)
            ) / 2
    ...
    def getZFromXYAndPlane(self, point, planeABC):
        ...
        # Return Z
        return (
            planeABC[0] * point.x + planeABC[1] * point.y + planeABC[3]
        ) / -planeABC[2]
    ...
    def preprocess(self, input, output=None, lastCommand=False):
        ...
        while True:
            ...
            if output is not None:
                ...
                if not self.printingTestBorder and not self.printingBacklashCalibration:
                    ...
                    self._plugin_manager.send_plugin_message(
                        ...
                        dict(
                            value="Progress bar text",
                            text=gettext("Pre‐processing … (%(percent)s)"),
                            percent=str(
                                input.tell() * 100 / os.fstat(input.fileno()).st_size
                            )
                            + "%",
                        ),
                    )
            ...
            if not gcode.isEmpty():
                ...
                if (
                    command.origin == "INPUT"
                    and command.skip == "NONE"
                    and gcode.hasValue("G")
                ):
                    ...
                    if gcode.getValue("G") == "0" or gcode.getValue("G") == "1":
                        ...
                        if (
                            newE > self.currentE
                            and self.currentZ not in self.printedLayers
                        ):
            ...
            if (
                not self.printingTestBorder
                and not self.printingBacklashCalibration
                and len(self.midPrintFilamentChangeLayers)
                and "MID-PRINT" not in command.skip
            ):
                ...
                if self.onNewPrintedLayer:
                    ...
                    if (
                        str(self.midPrintFilamentChangeLayerCounter)
                        in self.midPrintFilamentChangeLayers
                    ):
                        ...
                        if not gcode.isEmpty():
                            commands.append(
                                Command(gcode.getAscii(), command.origin, command.skip)
                            )
                        else:
                            commands.append(
                                Command(command.line, command.origin, command.skip)
                            )
            ...
            if (
                ...
                and not self.printingBacklashCalibration
                and self._settings.get_boolean(["UseCenterModelPreprocessor"])
                and "CENTER" not in command.skip
            ):
                ...
                if not gcode.isEmpty():
                    ...
                    # Check if command is G0 or G1
                    if gcode.hasValue("G") and (
                        gcode.getValue("G") == "0" or gcode.getValue("G") == "1"
                    ):
                        ...
                        if gcode.hasValue("X"):
                            ...
                            gcode.setValue(
                                "X",
                                "%f"
                                % (float(gcode.getValue("X")) + self.displacementX),
                            )
                        ...
                        if gcode.hasValue("Y"):
                            ...
                            gcode.setValue(
                                "Y",
                                "%f"
                                % (float(gcode.getValue("Y")) + self.displacementY),
                            )

            # Check if printing test border or backlash calibration or using validation pre-processor
            if (
                self.printingTestBorder
                or self.printingBacklashCalibration
                or self._settings.get_boolean(["UseValidationPreprocessor"])
            ) and "VALIDATION" not in command.skip:
                ...
                if not gcode.isEmpty():
                    ...
                    if gcode.hasValue("M") and (
                        gcode.getValue("M") == "82"
                        or gcode.getValue("M") == "83"
                        or gcode.getValue("M") == "84"
                        or gcode.getValue("M") == "117"
                        or (
                            (
                                self.currentFirmwareType == "M3D"
                                or self.currentFirmwareType == "M3D Mod"
                            )
                            and gcode.getValue("M") == "105"
                        )
                    ):
                    ...
                    if gcode.hasValue("G") and (
                        gcode.getValue("G") == "21" or gcode.getValue("G") == "28"
                    ):
                    ...
                    if (
                        self._settings.get_boolean(["RemoveFanCommands"])
                        and gcode.hasValue("M")
                        and (
                            gcode.getValue("M") == "106" or gcode.getValue("M") == "107"
                        )
                    ):
                    ...
                    if (
                        self._settings.get_boolean(["RemoveTemperatureCommands"])
                        and gcode.hasValue("M")
                        and (
                            gcode.getValue("M") == "104"
                            or gcode.getValue("M") == "109"
                            or gcode.getValue("M") == "140"
                            or gcode.getValue("M") == "190"
                        )
                    ):
            ...
            if (
                self.printingTestBorder
                or self.printingBacklashCalibration
                or self._settings.get_boolean(["UsePreparationPreprocessor"])
            ) and "PREPARATION" not in command.skip:
                ...
                if not self.addedIntro:
                    ...
                    if (
                        ...
                        if cornerX > 0 and cornerY > 0:
                            cornerZ = self._settings.get_float(
                                ["BackRightOrientation"]
                            ) + self._settings.get_float(["BackRightOffset"])
                    ...
                    newCommands.append(
                        Command(
                            "G90",
                            "PREPARATION",
                            "MID-PRINT CENTER VALIDATION PREPARATION",
                        )
                    )
                    if self._settings.get_boolean(["ChangeLedBrightness"]):
                        newCommands.append(
                    ...
                    newCommands.append(
                        Command(
                            "M104 S"
                            + str(self._settings.get_int(["FilamentTemperature"])),
                            "PREPARATION",
                            "MID-PRINT CENTER VALIDATION PREPARATION",
                        )
                    )
                    ...
                    if cornerX == 0 or cornerY == 0:
                        ...
                        if self.heatbedConnected:
                            newCommands.append(
                                Command(
                                    "M190 S"
                                    + str(
                                        self._settings.get_int(["HeatbedTemperature"])
                                    ),
                                    "PREPARATION",
                                    "MID-PRINT CENTER VALIDATION PREPARATION",
                                )
                        ...
                        if self.temperatureStabalizationDelay != 0:
                            newCommands.append(
                                Command(
                                    "G4 S" + str(self.temperatureStabalizationDelay),
                                    "PREPARATION",
                                    "MID-PRINT CENTER VALIDATION PREPARATION",
                                )
                            )
                    ...
                    # Otherwise
                        ...
                        newCommands.append(
                            Command(
                                "G0 X%f Y%f F1800" % (54 + cornerX, 50 + cornerY),
                                "PREPARATION",
                                "MID-PRINT CENTER VALIDATION PREPARATION",
                            )
                        )
                        ...
                        newCommands.append(
                            Command(
                                "G0 X%f Y%f Z%f F400"
                                % (
                                    54 + cornerX - cornerX * 0.1,
                                    50 + cornerY - cornerY * 0.1,
                                    cornerZ + 0.5,
                                ),
                                "PREPARATION",
                                "MID-PRINT CENTER VALIDATION PREPARATION",
                ...
                if (
                    ...
                    and (
                        (
                            output is not None
                            and input.tell() == os.fstat(input.fileno()).st_size
                        )
                        or lastCommand
                    )
                ):
                    ...
                    newCommands.append(
                        Command(
                            "G0 Y%f Z%f E-8 F1800" % (moveY, moveZ),
                            "PREPARATION",
                            "MID-PRINT CENTER VALIDATION PREPARATION",
                        )
                    )
                ...
                # Otherwise check if command is on a new printed layer
                    ...
                    if self._settings.get_boolean(["UseGpio"]):
                        ...
                        if (
                            gpioLayer is not None
                            and self.preparationLayerCounter == gpioLayer
                        ):
                            ...
                            if not gcode.isEmpty():
                                commands.append(
                                    Command(
                                        gcode.getAscii(), command.origin, command.skip
                                    )
                                )
                            else:
                                commands.append(
            ...
            if (
                not self.printingTestBorder
                and not self.printingBacklashCalibration
                and self._settings.get_boolean(["UseWaveBondingPreprocessor"])
                and "WAVE" not in command.skip
            ):
                ...
                if self.waveBondingLayerCounter == 1:
                    ...
                    if not gcode.isEmpty():
                        ...
                        if gcode.hasValue("G"):
                            ...
                            if (
                                gcode.getValue("G") == "0" or gcode.getValue("G") == "1"
                            ) and not self.waveBondingRelativeMode:
                                ...
                                if gcode.hasValue("X"):
                                    deltaX = (
                                        float(gcode.getValue("X"))
                                        - self.waveBondingPositionRelativeX
                                    )
                                else:
                                    deltaX = 0
                                ...
                                if gcode.hasValue("Y"):
                                    deltaY = (
                                        float(gcode.getValue("Y"))
                                        - self.waveBondingPositionRelativeY
                                    )
                                else:
                                    deltaY = 0
                                ...
                                if gcode.hasValue("Z"):
                                    deltaZ = (
                                        float(gcode.getValue("Z"))
                                        - self.waveBondingPositionRelativeZ
                                    )
                                else:
                                    deltaZ = 0
                                ...
                                if gcode.hasValue("E"):
                                    deltaE = (
                                        float(gcode.getValue("E"))
                                        - self.waveBondingPositionRelativeE
                                    )
                                else:
                                    deltaE = 0
                                ...
                                if distance > self.wavePeriodQuarter:
                                    waveRatio = int(
                                        float(str(distance / self.wavePeriodQuarter))
                                    )
                                else:
                                    waveRatio = 1
                                ...
                                if deltaE > 0:
                                    ...
                                    if (
                                        not self.waveBondingPreviousGcode.isEmpty()
                                        and self.isSharpCornerForWaveBonding(
                                            gcode, self.waveBondingPreviousGcode
                                        )
                                    ):

                                        # Check if a tack point was created
                                        self.waveBondingTackPoint = (
                                            self.createTackPointForWaveBonding(
                                                gcode, self.waveBondingRefrenceGcode
                                            )
                                        )
                                        if not self.waveBondingTackPoint.isEmpty():
                                            ...
                                            newCommands.append(
                                                Command(
                                                    self.waveBondingTackPoint.getAscii(),
                                                    "WAVE",
                                                    "MID-PRINT CENTER VALIDATION PREPARATION WAVE",
                                                )
                                            )

                                        # Set refrence G-code
                                        self.waveBondingRefrenceGcode = copy.deepcopy(
                                            gcode
                                        )
                                    ...
                                    while index <= waveRatio:
                                        ...
                                        if index != waveRatio:
                                            ...
                                            self.waveBondingExtraGcode.setValue(
                                                "G", gcode.getValue("G")
                                            )
                                            ...
                                            # Otherwise check if command has a Z value and changes in Z are noticable
                                                ...
                                                gcode.hasValue("Z")
                                                and deltaZ != sys.float_info.epsilon
                                            ):
                                            ...
                                            newCommands.append(
                                                Command(
                                                    self.waveBondingExtraGcode.getAscii(),
                                                    "WAVE",
                                                    "MID-PRINT CENTER VALIDATION PREPARATION WAVE",
                                                )
                                            )
                            ...
                            # Otherwise check if command is G92
                                ...
                                if (
                                    ...
                                    if gcode.hasValue("X"):
                                        self.waveBondingPositionRelativeX = float(
                                            gcode.getValue("X")
                                        )

                                    if gcode.hasValue("Y"):
                                        self.waveBondingPositionRelativeY = float(
                                            gcode.getValue("Y")
                                        )

                                    if gcode.hasValue("Z"):
                                        self.waveBondingPositionRelativeZ = float(
                                            gcode.getValue("Z")
                                        )

                                # Set relative positions
                                if gcode.hasValue("E"):
                                    self.waveBondingPositionRelativeE = float(
                                        gcode.getValue("E")
                                    )
            ...
            if (
                self.printingTestBorder
                or self.printingBacklashCalibration
                or self._settings.get_boolean(["UseThermalBondingPreprocessor"])
            ) and "THERMAL" not in command.skip:
                        ...
                        if self.currentFirmwareType == "M3D Mod":
                            newCommands.append(
                                Command(
                                    "M109 S"
                                    + str(
                                        self.getBoundedTemperature(
                                            self._settings.get_int(
                                                ["FilamentTemperature"]
                                            )
                                            + self.firstLayerTemperatureChange,
                                            315,
                                        )
                                    ),
                                    "THERMAL",
                                    "MID-PRINT CENTER VALIDATION PREPARATION WAVE THERMAL",
                                )
                            )
                        else:
                            newCommands.append(
                ...
                if self.thermalBondingLayerCounter == 1:
                    ...
                    if not gcode.isEmpty():
                        ...
                        if (
                            self.printingTestBorder
                            or not self._settings.get_boolean(
                                ["UseWaveBondingPreprocessor"]
                            )
                        ) and gcode.hasValue("G"):
                            ...
                            if (
                                gcode.getValue("G") == "0" or gcode.getValue("G") == "1"
                            ) and not self.thermalBondingRelativeMode:

                                # Check if tack points can be created
                                if (
                                    self.tackPointAngle != 0
                                    and self.tackPointTime >= 0.001
                                ):

                                    # Check if at a sharp corner
                                    if (
                                        not self.thermalBondingPreviousGcode.isEmpty()
                                        and self.isSharpCornerForThermalBonding(
                                            gcode,
                                            self.thermalBondingPreviousGcode,
                                            self.tackPointAngle,
                                        )
                                    ):

                                        # Check if a tack point was created
                                        self.thermalBondingTackPoint = (
                                            self.createTackPointForThermalBonding(
                                                gcode,
                                                self.thermalBondingRefrenceGcode,
                                                self.tackPointTime,
                                            )
                                        )
                                        if not self.thermalBondingTackPoint.isEmpty():
                                            ...
                                            newCommands.append(
                                                Command(
                                                    self.thermalBondingTackPoint.getAscii(),
                                                    "THERMAL",
                                                    "MID-PRINT CENTER VALIDATION PREPARATION WAVE THERMAL",
                                                )
                                            )
                                    ...
                                    # Set previous G-code
                                    self.thermalBondingPreviousGcode = copy.deepcopy(
                                        gcode
                                    )
            ...
            if (
                ...
                and (
                    self.printingTestBorder
                    or self.printingBacklashCalibration
                    or self._settings.get_boolean(["UseBedCompensationPreprocessor"])
                )
                and "BED" not in command.skip
            ):
                ...
                if not gcode.isEmpty():
                    ...
                    if gcode.hasValue("G"):
                        ...
                        if (
                            gcode.getValue("G") == "0" or gcode.getValue("G") == "1"
                        ) and not self.bedCompensationRelativeMode:
                            ...
                            if gcode.hasValue("Z"):
                                ...
                                gcode.setValue(
                                    ...
                                    % (
                                        float(gcode.getValue("Z"))
                                        + self._settings.get_float(["BedHeightOffset"])
                                    ),
                                )
                            ...
                            if gcode.hasValue("X"):
                                deltaX = (
                                    float(gcode.getValue("X"))
                                    - self.bedCompensationPositionRelativeX
                                )
                            else:
                                deltaX = 0
                            ...
                            if gcode.hasValue("Y"):
                                deltaY = (
                                    float(gcode.getValue("Y"))
                                    - self.bedCompensationPositionRelativeY
                                )
                            else:
                                deltaY = 0
                            ...
                            if gcode.hasValue("Z"):
                                deltaZ = (
                                    float(gcode.getValue("Z"))
                                    - self.bedCompensationPositionRelativeZ
                                )
                            else:
                                deltaZ = 0
                            ...
                            if gcode.hasValue("E"):
                                deltaE = (
                                    float(gcode.getValue("E"))
                                    - self.bedCompensationPositionRelativeE
                                )
                            else:
                                deltaE = 0
                            ...
                            if distance > self.segmentLength:
                                segmentCounter = int(
                                    float(str(distance / self.segmentLength))
                                )
                            else:
                                segmentCounter = 1
                            ...
                            if deltaE > 0:
                                ...
                                while index <= segmentCounter:
                                    ...
                                    if index == segmentCounter:
                                        ...
                                        # Set temp values
                                        tempAbsoluteX = (
                                            self.bedCompensationPositionAbsoluteX
                                        )
                                        tempAbsoluteY = (
                                            self.bedCompensationPositionAbsoluteY
                                        )
                                        tempRelativeX = (
                                            self.bedCompensationPositionRelativeX
                                        )
                                    ...
                                    # Otherwise
                                        ...
                                        tempAbsoluteX = (
                                            absoluteDifferenceX
                                            + index * self.segmentLength * deltaRatioX
                                        )
                                        tempAbsoluteY = (
                                            absoluteDifferenceY
                                            + index * self.segmentLength * deltaRatioY
                                        )
                                        tempRelativeX = (
                                            relativeDifferenceX
                                            + index * self.segmentLength * deltaRatioX
                                        ...
                                        tempRelativeZ = (
                                            relativeDifferenceZ
                                            + index * self.segmentLength * deltaRatioZ
                                        )
                                        tempRelativeE = (
                                            relativeDifferenceE
                                            + index * self.segmentLength * deltaRatioE
                                        )

                                    # Get height adjustment
                                    heightAdjustment = self.getHeightAdjustmentRequired(
                                        tempAbsoluteX, tempAbsoluteY
                                    )
                                    ...
                                    if index != segmentCounter:
                                        ...
                                        self.bedCompensationExtraGcode.setValue(
                                            "G", gcode.getValue("G")
                                        )
                                        ...
                                        newCommands.append(
                                            Command(
                                                self.bedCompensationExtraGcode.getAscii(),
                                                "BED",
                                                "MID-PRINT CENTER VALIDATION PREPARATION WAVE THERMAL BED",
                                            )
                                        )
                        ...
                        # Otherwise check if command is G92
                            ...
                            if (
                                ...
                                if gcode.hasValue("Z"):
                                    self.bedCompensationPositionRelativeZ = float(
                                        gcode.getValue("Z")
                                    )

                            # Set relative and absolute positions
                            if gcode.hasValue("E"):
                                self.bedCompensationPositionRelativeE = float(
                                    gcode.getValue("E")
                                )
            ...
            if (
                ...
                and (
                    self.printingTestBorder
                    or self.printingBacklashCalibration
                    or self._settings.get_boolean(
                        ["UseBacklashCompensationPreprocessor"]
                    )
                )
                and "BACKLASH" not in command.skip
            ):
                ...
                if not gcode.isEmpty():
                    ...
                    if gcode.hasValue("G"):
                        ...
                        if (
                            gcode.getValue("G") == "0" or gcode.getValue("G") == "1"
                        ) and not self.backlashCompensationRelativeMode:
                            ...
                            if gcode.hasValue("X"):
                                deltaX = (
                                    float(gcode.getValue("X"))
                                    - self.backlashPositionRelativeX
                                )
                            else:
                                deltaX = 0
                            ...
                            if gcode.hasValue("Y"):
                                deltaY = (
                                    float(gcode.getValue("Y"))
                                    - self.backlashPositionRelativeY
                                )
                            else:
                                deltaY = 0
                            ...
                            if gcode.hasValue("Z"):
                                deltaZ = (
                                    float(gcode.getValue("Z"))
                                    - self.backlashPositionRelativeZ
                                )
                            else:
                                deltaZ = 0
                            ...
                            if gcode.hasValue("E"):
                                deltaE = (
                                    float(gcode.getValue("E"))
                                    - self.backlashPositionRelativeE
                                )
                            else:
                                deltaE = 0
                            ...
                            if (
                                directionX != self.previousDirectionX
                                and self.previousDirectionX != "Neither"
                            ) or (
                                directionY != self.previousDirectionY
                                and self.previousDirectionY != "Neither"
                            ):

                                # Set extra G-code G value
                                self.backlashCompensationExtraGcode.clear()
                                self.backlashCompensationExtraGcode.setValue(
                                    "G", gcode.getValue("G")
                                )
                                ...
                                if (
                                    ...
                                    if directionX == "Positive":
                                        self.compensationX += self._settings.get_float(
                                            ["BacklashX"]
                                        )
                                    else:
                                        self.compensationX -= self._settings.get_float(
                                ...
                                if (
                                    ...
                                    if directionY == "Positive":
                                        self.compensationY += self._settings.get_float(
                                            ["BacklashY"]
                                        )
                                    else:
                                        self.compensationY -= self._settings.get_float(
                                ...
                                self.backlashCompensationExtraGcode.setValue(
                                    "F",
                                    "%f"
                                    % (self._settings.get_float(["BacklashSpeed"])),
                                )

                                # Add extra G-code to output
                                newCommands.append(
                                    Command(
                                        self.backlashCompensationExtraGcode.getAscii(),
                                        "BACKLASH",
                                        "MID-PRINT CENTER VALIDATION PREPARATION WAVE THERMAL BED BACKLASH",
                                    )
                                )
                            ...
                            if gcode.hasValue("X"):
                                ...
                                gcode.setValue(
                                    "X",
                                    "%f"
                                    % (float(gcode.getValue("X")) + self.compensationX),
                                )
                            ...
                            if gcode.hasValue("Y"):
                                ...
                                gcode.setValue(
                                    "Y",
                                    "%f"
                                    % (float(gcode.getValue("Y")) + self.compensationY),
                                )
                        ...
                        # Otherwise check if command is G92
                            ...
                            if (
                                ...
                                # Set relative positions
                                if gcode.hasValue("X"):
                                    self.backlashPositionRelativeX = float(
                                        gcode.getValue("X")
                                    )

                                if gcode.hasValue("Y"):
                                    self.backlashPositionRelativeY = float(
                                        gcode.getValue("Y")
                                    )

                                if gcode.hasValue("Z"):
                                    self.backlashPositionRelativeZ = float(
                                        gcode.getValue("Z")
                                    )

                            # Set relative positions
                            if gcode.hasValue("E"):
                                self.backlashPositionRelativeE = float(
                                    gcode.getValue("E")
                                )
            ...
            if (
                ...
                and (
                    self.printingTestBorder
                    or self.printingBacklashCalibration
                    or self._settings.get_boolean(["UseSkewCompensationPreprocessor"])
                )
                and "SKEW" not in command.skip
            ):
                ...
                if not gcode.isEmpty():
                    ...
                    if gcode.hasValue("G"):
                        ...
                        if (
                            gcode.getValue("G") == "0" or gcode.getValue("G") == "1"
                        ) and not self.skewCompensationRelativeMode:

                            # Set delta value
                            if gcode.hasValue("Z"):
                                deltaZ = (
                                    float(gcode.getValue("Z"))
                                    - self.skewCompensationPositionRelativeZ
                                )
                            else:
                                deltaZ = 0
                            ...
                            if gcode.hasValue("X"):
                                ...
                                gcode.setValue(
                                    ...
                                    % (
                                        float(gcode.getValue("X"))
                                        + self.skewCompensationPositionAbsoluteZ
                                        / (self.bedHighMaxZ - self.bedLowMinZ)
                                        * -self._settings.get_float(["SkewX"])
                                    ),
                                )
                        ...
                        # Otherwise check if command is G92
                            ...
                            if (
                                ...
                                if gcode.hasValue("Z"):
                                    self.skewCompensationPositionRelativeZ = float(
                                        gcode.getValue("Z")
                                    )
    ...
    def upload(self):
        ...
        if (
            "Slicer Profile Identifier" in flask.request.values
            and "Slicer Name" in flask.request.values
            and "Printer Profile Name" in flask.request.values
            and "Slicer Profile Content" in flask.request.values
            and "After Slicing Action" in flask.request.values
        ):

            # Check if printing after slicing and a printer isn't connected
            if (
                flask.request.values["After Slicing Action"] != "none"
            ...
            modelModified = (
                "Model Name" in flask.request.values
                and "Model Origin" in flask.request.values
                and "Model Path" in flask.request.values
            )

            # Check if slicer profile identifier, model name, or model path contain path traversal
            if "../" in flask.request.values["Slicer Profile Identifier"] or (
                modelModified
                and (
                    "../" in flask.request.values["Model Name"]
                    or "../" in flask.request.values["Model Path"]
                )
            ):
            ...
            if modelModified and (
                flask.request.values["Model Origin"] != "local"
                and flask.request.values["Model Origin"] != "sdcard"
            ):
            ...
            if (
                flask.request.values["Slicer Name"]
                not in self._slicing_manager.configured_slicers
            ):
            ...
            profileLocation = self._slicing_manager.get_profile_path(
                flask.request.values["Slicer Name"],
                flask.request.values["Slicer Profile Identifier"],
            )
            ...
            if modelModified:
                ...
                if flask.request.values["Model Origin"] == "local":
                    modelLocation = self._file_manager.path_on_disk(
                        octoprint.filemanager.destinations.FileDestinations.LOCAL,
                        flask.request.values["Model Path"]
                        + flask.request.values["Model Name"],
                    ).replace("\\", "/")
                elif flask.request.values["Model Origin"] == "sdcard":
                    modelLocation = self._file_manager.path_on_disk(
                        octoprint.filemanager.destinations.FileDestinations.SDCARD,
                        flask.request.values["Model Path"]
                        + flask.request.values["Model Name"],
                    ).replace("\\", "/")
            ...
            if (
                not os.path.isfile(profileLocation)
                or (modelModified and not os.path.isfile(modelLocation))
                or not self._printer_profile_manager.exists(
                    flask.request.values["Printer Profile Name"]
                )
            ):
            ...
            if flask.request.values["Slicer Name"] == "cura":
                ...
                search = re.findall(
                    "extruder_amount\\s*?=\\s*?(\\d+)",
                    flask.request.values["Slicer Profile Content"],
                )
                if len(search):
                    printerProfile["extruder"]["count"] = int(search[0])

                search = re.findall(
                    "has_heated_bed\\s*?=\\s*?(\\S+)",
                    flask.request.values["Slicer Profile Content"],
                )
                if len(search):
                ...
                search = re.findall(
                    "extruder_offset_(x|y)(\\d)\\s*?=\\s*?(-?\\d+.?\\d*)",
                    flask.request.values["Slicer Profile Content"],
                )
        ...
        # Otherwise check if saving profile
            ...
            "Slicer Profile Identifier" in flask.request.values
            and "Slicer Profile Name" in flask.request.values
            and "Slicer Profile Content" in flask.request.values
            and "Slicer Name" in flask.request.values
            and "Replace Existing" in flask.request.values
        ):

            # Check if slicer profile identifier or slicer profile name contains path traversal or slicer isn't configured
            if (
                "../" in flask.request.values["Slicer Profile Identifier"]
                or "../" in flask.request.values["Slicer Profile Name"]
                or flask.request.values["Slicer Name"]
                not in self._slicing_manager.configured_slicers
            ):
            ...
            profileDestination = (
                self._slicing_manager.get_slicer_profile_path(
                    flask.request.values["Slicer Name"]
                ).replace("\\", "/")
                + "/"
            )
            ...
            if flask.request.values["Replace Existing"] == "false":
                ...
                profileIdentifier = self._slicing_manager.get_profile_path(
                    flask.request.values["Slicer Name"],
                    flask.request.values["Slicer Profile Name"],
                )[len(profileDestination) :].lower()

                # Make sure profile name is unique
                while os.path.isfile(profileDestination + profileIdentifier):
                    profileIdentifier = (
                        os.path.splitext(profileIdentifier)[0]
                        + "_"
                        + os.path.splitext(profileIdentifier)[1]
                    )
            ...
            if flask.request.values["Slicer Name"] == "cura":
                ...
                if not hasattr(
                    ...
                    "from_" + flask.request.values["Slicer Name"] + "_ini",
                ):
                ...
                self._slicing_manager.get_slicer(
                    flask.request.values["Slicer Name"]
                ).save_slicer_profile(profileDestination + profileIdentifier, profile)
        ...
        # Otherwise check if verifying profile
            ...
            "Slicer Profile Content" in flask.request.values
            and "Slicer Name" in flask.request.values
        ):
    ...
    def download(self, file):
        ...
        if "../" in file or not os.path.isfile(
            self.get_plugin_data_folder().replace("\\", "/") + "/" + file
        ):
    ...
    def autoConnect(self, comm_instance, port, baudrate, read_timeout, *args, **kwargs):
        ...
        # Otherwise check if using macOS, Linux, or FreeBSD and the user lacks read/write access to the printer
            ...
            or platform.uname()[0].startswith("Linux")
            or platform.uname()[0].startswith("FreeBSD")
        ) and not os.access(str(port), os.R_OK | os.W_OK):
    ...
    def disableSleep(self):
        ...
        if platform.uname()[0].startswith("Windows"):
            ...
            ctypes.windll.kernel32.SetThreadExecutionState(
                ctypes.c_int(ES_CONTINUOUS | ES_SYSTEM_REQUIRED)
            )
        ...
        # Otherwise check if using macOS and ObjC is usable
            ...
            def setUpIOFramework():
                ...
                framework.IOPMAssertionRelease.argtypes = [ctypes.c_uint32]
            ...
            def stringToCFString(string):
                ...
                return objc.pyobjc_id(
                    CoreFoundation.CFStringCreateWithCString(
                        None, string, encoding
                    ).nsstring()
                )

            def assertionCreateWithName(
                framework, assertionType, assertionLevel, assertionReason
            ):
                ...
                assertionError = framework.IOPMAssertionCreateWithName(
                    assertionType,
                    assertionLevel,
                    assertionReason,
            ...
            error, self.osXSleepPrevention = assertionCreateWithName(
                self.osXSleepFramework,
        ...
        # Otherwise check if using Linux or FreeBSD and DBus is usable
            ...
            platform.uname()[0].startswith("Linux")
            or platform.uname()[0].startswith("FreeBSD")
        ) and "dbus" in sys.modules:
            ...
            if not hasattr(self, "dbusSleepService") or self.dbusSleepService is None:
                ...
                try:
                    self.dbusSleepService = dbus.Interface(
                        bus.get_object(
                            "org.gnome.ScreenSaver", "/org/gnome/ScreenSaver"
                        ),
                        "org.gnome.ScreenSaver",
                    )
                    self.dbusSleepPrevention = self.dbusSleepService.Inhibit(
                        "M33 Fio", "Disabled by M33 Fio"
                    )
                    ...
                    try:
                        self.dbusSleepService = dbus.Interface(
                            bus.get_object("org.gnome.ScreenSaver", "/ScreenSaver"),
                            "org.gnome.ScreenSaver",
                        )
                        self.dbusSleepPrevention = self.dbusSleepService.Inhibit(
                            "M33 Fio", "Disabled by M33 Fio"
                        ...
                        try:
                            ...
                            try:
                                ...
                                self.dbusSleepPrevention = (
                                    self.dbusSleepService.Inhibit(
                                        "M33 Fio", "Disabled by M33 Fio"
                                    )
                                )
    ...
    def enableSleep(self):
        ...
        # Otherwise check if using macOS and ObjC is usable
            ...
            if (
                hasattr(self, "osXSleepFramework")
                and self.osXSleepFramework is not None
            ):
            ...
            if platform.uname()[0].startswith("Linux"):
                ...
                # Check if WiringPi isn't installed
                    ...
                    if exception.errno == os.errno.ENOENT:
                        ...
                        os.system(
                            'echo "' + str(gpioPin) + '" > /sys/class/gpio/export'
                        )
                        os.system(
                        ...
                        os.system(
                            'echo "1" > /sys/class/gpio/gpio' + str(gpioPin) + "/value"
                        )
                        os.system(
                            'echo "' + str(gpioPin) + '" > /sys/class/gpio/unexport'
                        )
            ...
            if platform.uname()[0].startswith("Linux"):
                ...
                # Check if WiringPi isn't installed
                    ...
                    if exception.errno == os.errno.ENOENT:
                        ...
                        os.system(
                            'echo "0" > /sys/class/gpio/gpio' + str(gpioPin) + "/value"
                        )
                        os.system(
                            'echo "' + str(gpioPin) + '" > /sys/class/gpio/unexport'
                        )
